...
public class TileManager {
    ...
    public void getTileImage() {
        ...
        if(mapName.equals("farmMap")) {
            ...
            setup(741, mapName, "#741", true);
            setup(742, mapName, "#742", true);
            setup(743, mapName, "#743", true);
            setup(744, mapName, "#744", true);
            setup(745, mapName, "#745", true);
            setup(746, mapName, "#746", true);
            setup(747, mapName, "#747", true);
            setup(748, mapName, "#748", true);
            setup(749, mapName, "#749", true);
            setup(750, mapName, "#750", true);
            setup(751, mapName, "#751", true);
            setup(752, mapName, "#752", true);
            setup(754, mapName, "#754", true);
            setup(755, mapName, "#755", true);
            setup(756, mapName, "#756", true);
            setup(796, mapName, "#796", true);
            setup(797, mapName, "#797", true);
            setup(837, mapName, "#837", true);
            setup(838, mapName, "#838", true);
