...
public class OBJ_House5 extends SuperObject {

    public OBJ_House5(GamePanel gp, int x, int y) {
        name = "House5";
        try {
            image = ImageIO.read(getClass().getResourceAsStream("/objects/House5.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
        collision = true; 
